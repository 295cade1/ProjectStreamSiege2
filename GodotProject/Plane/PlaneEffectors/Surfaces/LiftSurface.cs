...
public partial class LiftSurface : DragSurface
{
	...
	public override Vector3 getSurfaceForce(Vector3 velocity){
		...
		float liftAmount = 0.5f * velocity.Length() * velocity.Length() * AIRDENSITY * y_area * Mathf.Clamp(liftCurve.Sample(Mathf.Clamp(angleOfAttack/ANGLEOFATTACKMAX, 0.0f, 1.0f)),0.0f,1.0f) * liftCoefficient;
